...
class _ItemApiService implements ItemApiService {
  _ItemApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<ItemModel> patchItem(int id, Map<String, dynamic> data) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
